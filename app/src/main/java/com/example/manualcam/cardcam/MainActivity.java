package com.example.manualcam.cardcam;
...
import com.example.manualcam.R;
...
public class MainActivity extends AppCompatActivity  implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    Button camera_open_id,manual_camera_button;
...
//    private Bitmap bitmap;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        manual_camera_button = (Button)findViewById(R.id.manual_camera_button);
    /*    manual_camera_button.setOnClickListener(new View.OnClickListener() {
            @Override
